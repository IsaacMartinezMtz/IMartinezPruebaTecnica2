...
namespace DL
{
    ...
    public partial class IMartinezPruebaTecnica2Entities1 : DbContext
    {
        public IMartinezPruebaTecnica2Entities1()
            : base("name=IMartinezPruebaTecnica2Entities1")
        {
        }
        ...
        public virtual int DiscoAdd(string titulo, string artista, string generoMusical, string duracion, string año, string distibuidora, Nullable<int> vENTAS, string disponibilidad)
        {
        ...
        public virtual int DiscoUpdate(Nullable<int> idDisco, string titulo, string artista, string generoMusical, string duracion, string año, string distibuidora, Nullable<int> vENTAS, string disponibilidad)
        {
            var idDiscoParameter = idDisco.HasValue ?
                new ObjectParameter("IdDisco", idDisco) :
                new ObjectParameter("IdDisco", typeof(int));
